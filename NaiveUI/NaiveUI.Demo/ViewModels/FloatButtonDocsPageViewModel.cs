...
public sealed class FloatButtonDocsPageViewModel : ViewModelBase
{
    public FloatButtonDocsPageViewModel()
    {
        ...
        [
            ...
            new ApiDocRow { Name = "CustomBackgroundBrush", Type = "Brush", DefaultValue = "null", Description = "自定义按钮常态背景色。设置后会覆盖 Type 对应的默认背景色。", Version = "2.38.0" },
            new ApiDocRow { Name = "CustomForegroundBrush", Type = "Brush", DefaultValue = "null", Description = "自定义按钮常态前景色，通常用于自定义图标或文字颜色。", Version = "2.38.0" },
            new ApiDocRow { Name = "CustomHoverBackgroundBrush", Type = "Brush", DefaultValue = "null", Description = "自定义按钮悬浮态背景色。未设置时会回退到常态背景或主题默认悬浮色。", Version = "2.38.0" },
            new ApiDocRow { Name = "CustomHoverForegroundBrush", Type = "Brush", DefaultValue = "null", Description = "自定义按钮悬浮态前景色。", Version = "2.38.0" },
            new ApiDocRow { Name = "CustomPressedBackgroundBrush", Type = "Brush", DefaultValue = "null", Description = "自定义按钮按下态背景色。", Version = "2.38.0" },
            new ApiDocRow { Name = "CustomPressedForegroundBrush", Type = "Brush", DefaultValue = "null", Description = "自定义按钮按下态前景色。", Version = "2.38.0" },
            new ApiDocRow { Name = "MenuPlacement", Type = "Top | Right | Bottom | Left", DefaultValue = "Top", Description = "菜单弹出位置。支持上、右、下、左四个方向。", Version = "2.38.0" },
            new ApiDocRow { Name = "MenuOrientation", Type = "Vertical | Horizontal", DefaultValue = "Vertical", Description = "菜单内容未显式设置 Orientation 时的默认排列方向。若在 NFloatButtonStackPanel、StackPanel、WrapPanel 等容器上直接设置了 Orientation，则以容器自身配置为准。", Version = "2.38.0" },
            ...
            new ApiDocRow { Name = "Type", Type = "Default | Primary | Info | Success | Warning | Error | Customize", DefaultValue = "Default", Description = "按钮语义色类型。Customize 通常与 CustomBackgroundBrush、CustomForegroundBrush、CustomPressedBackgroundBrush 等属性配合使用。", Version = "2.38.0" },
        ];
        ...
        [
            ...
            new ApiDocRow { Name = "Background", Type = "Brush", DefaultValue = "Transparent / Square 时为 Theme.Surface.0.Brush", Description = "按钮组容器背景色。方形按钮组默认会使用主题面板色，手动设置后可覆盖默认值。", Version = "2.38.0" },
            new ApiDocRow { Name = "Padding", Type = "Thickness", DefaultValue = "0", Description = "按钮组容器内边距。可为按钮内容与组边界之间留出额外空白。", Version = "2.38.0" },
            new ApiDocRow { Name = "CornerRadius", Type = "CornerRadius", DefaultValue = "8", Description = "按钮组容器圆角。常用于方形按钮组的外轮廓调整。", Version = "2.38.0" },
            new ApiDocRow { Name = "BorderBrush", Type = "Brush", DefaultValue = "Transparent", Description = "按钮组容器边框颜色。", Version = "2.38.0" },
            new ApiDocRow { Name = "BorderThickness", Type = "Thickness", DefaultValue = "0", Description = "按钮组容器边框粗细。", Version = "2.38.0" },
            ...
            new ApiDocRow { Name = "Orientation", Type = "Vertical | Horizontal", DefaultValue = "Vertical", Description = "按钮组排列方向。可配置纵向或横向布局。", Version = "2.38.0" },
