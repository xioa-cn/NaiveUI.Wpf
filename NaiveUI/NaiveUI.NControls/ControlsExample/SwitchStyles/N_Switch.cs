...
namespace NaiveUI.NControls.ControlsExample {
    ...
    public class N_Switch : RadioButton {
        static N_Switch() {
            ElementBase.DefaultStyle<N_Switch>(DefaultStyleKeyProperty);
        }
        ...
        public static readonly DependencyProperty CheckedColorProperty =
            ElementBase.Property<N_Switch, Brush>(nameof(CheckedColorProperty),
                new SolidColorBrush((Color)ColorConverter.ConvertFromString("#18a058")));
        ...
        public override void OnApplyTemplate() {
            ...
            if (thumb != null)
            {
                ...
                Storyboard.SetTargetProperty(onAnimation,
                ...
                Storyboard.SetTargetProperty(offAnimation,
                    new PropertyPath("(Border.RenderTransform).(TranslateTransform.X)"));
